...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  7.91,  8.67 }
    #define DEFAULT_Ki_LIST {   0.91,   0.92 }
    #define DEFAULT_Kd_LIST {  19.28, 20.46 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 67.47
  #define DEFAULT_bedKi 13.48
  #define DEFAULT_bedKd 255.13
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 95.18, 95.25 }  // default steps per unit for Kossel (GT2, 20 tooth)
